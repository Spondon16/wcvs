...
func ScanParameterCloaking() reportResult {
	...
	****************/
	...
	if sliceContains(impactfulQueries, cache.CBName) { // If the cachebuster is impactful, it shall be tested two times. One time appended and one time prepended.
